      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-4 py-8">
                ...
                {[
                  {
                    icon: Shield,
                    title: "Emergency SOS",
                    desc: "Send GPS location instantly",
                  },
                  {
                    icon: MapPin,
                    title: "Real-time Tracking",
                    desc: "GPS-based attendance sharing",
                  },
                  {
                    icon: Clock,
                    title: "RFID Access",
                    desc: "Seamless facility access",
                  },
                ].map((item, i) => (
                  <div
                    key={i}
        ...
        {activeTab === "sos" && (
          <div className="sos-tab-container p-4 space-y-4">
            {showNotification && (
              <div className="bg-red-500 text-white text-center py-2 rounded-lg shadow-md animate-pulse">
